...
import { createColor, listColor } from "../services";
...
const Page = () => {
  ...
  const onSubmit = async (data: { name: string }) => {
    setLoading(true);
    let response: Record<string, any> = await createColor(data);
    if (response["status"]) {
      getData();
  ...
  return (
    <div>
      <Breadcrumbs>
        ...
        <BreadcrumbItem className="text-primary">Colores</BreadcrumbItem>
      </Breadcrumbs>
