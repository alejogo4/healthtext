...
import { createLinea, listLinea } from "../services";
...
const Page = () => {
  ...
  const onSubmit = async (data: { name: string }) => {
    setLoading(true);
    let response: Record<string, any> = await createLinea(data);
    if (response["status"]) {
      getData();
  ...
  return (
    <div>
      <Breadcrumbs>
        ...
        <BreadcrumbItem className="text-primary">Lineas</BreadcrumbItem>
      </Breadcrumbs>
