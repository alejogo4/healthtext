...
import ClothFilter from './ClothFilter/ClothFilter';
import BiaFilter from './BiaFilter/BiaFilter';
import SeamFilter from './SeamFilter/SeamFilter';
...
const PhotosVariantCreate: FC<Props> = ({ id }) => {
...
export default PhotosVariantCreate;
