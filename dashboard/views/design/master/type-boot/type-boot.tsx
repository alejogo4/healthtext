  ...
  return (
    <div>
      <Breadcrumbs>
        ...
        <BreadcrumbItem className='text-primary'>Tipo de bota</BreadcrumbItem>
      </Breadcrumbs>
      <div className="grid grid-cols-[1fr_2fr] gap-4 mt-5">
        <Card>
          <CardHeader>
            <CardTitle>Nuevo tipo de bota</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid gap-4">
                <div className="col-span-2 flex flex-col gap-2">
                  <Label htmlFor="name">Nombre de la bota</Label>
                  <Input
                    type="text"
                    id="name"
                    {...register("name")}
